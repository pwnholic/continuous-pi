...
const GEMINI_UPLOAD_URL = getApiBaseUrl("gemini-web-upload");
...
/**
 * Check if Gemini Web is available by reading Chrome cookies.
...
/**
 * Get the active Google email from Gemini cookies.
 */
...
/**
 * Send a prompt to Gemini Web using Chrome cookies for auth.
 */
