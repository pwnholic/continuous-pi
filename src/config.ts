...
export const DEFAULTS = {
  ...
  geminiApiUploadBase:
    "https://generativelanguage.googleapis.com/upload/v1beta" as const,
...
export function getWebclawConfig(config?: Partial<WebSearchConfig>): {
  ...
  return {
    ...
    proxy: wc.proxy,
    fallbackToReadability:
      wc.fallbackToReadability ?? DEFAULTS.webclawFallbackToReadability,
  };
}
 ...
 */
export function getSummaryModels(
  configOverride?: Partial<WebSearchConfig>,
